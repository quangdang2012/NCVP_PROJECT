...
namespace BoxIdDb
{
    public class ExcelClass
    {
        ...
        public void exportExcel(DataGrid dgv)
        {
            ...
            try
            {
                ...
                for (int i = 0; i <= dgv.Rows.Count - 1; i++) //dong
                {
                    ...
                    {
                        DataGridCell cell = dgv.; //cot roi dong
                ...
                MessageBox.Show("Excel file created, you can find in the folder D:\\SN", "Notice", MessageBoxButton.OK, MessageBoxImage.Information);

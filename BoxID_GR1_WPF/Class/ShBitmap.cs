...
namespace BoxID_GR1_WPF
{
    public class ShBitmap
    {
        ...
        public static BitmapImage CopyToBpp(BitmapImage b, int bpp)
        {
            ...
            int w = int.Parse(b.Width.ToString()), h = int.Parse(b.Height.ToString());
            using (System.Drawing.Bitmap bmp = new System.Drawing.Bitmap(1000, 1000))
            {
                IntPtr hbm = bmp.GetHbitmap(); // this is step (1)
            }
            //
            ...
            BitmapImage b0 = BitmapImage.FromHbitmap(hbm0);
            //

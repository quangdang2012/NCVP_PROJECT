...
namespace BoxIdDb
{
    public class ShPrint
    {
        ...
        public void createBoxidFiles(string dir, string id, string config, string user, DataGridView dgv1, ref DataGridView dgv2, ref TextBox txt)
        {
            //boxId 名のテキストファイルを生成
